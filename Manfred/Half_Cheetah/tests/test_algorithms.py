"""
Unit and simulation tests for the HalfCheetah RL Workbench.
...
class TestConfigs(unittest.TestCase):
    ...
    def test_ep_config_defaults(self) -> None:
        ec = EpisodeConfig()
        self.assertEqual(ec.n_episodes, 500)
    ...
    def test_env_config_defaults(self) -> None:
        ...
        self.assertAlmostEqual(env.ctrl_cost_weight, 0.1)
...
class TestSimulationPPO(unittest.TestCase):
    """Short PPO training run on HalfCheetah-v5."""
